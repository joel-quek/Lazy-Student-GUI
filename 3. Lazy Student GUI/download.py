...
def download__transcribe_summarise_file():
    ...
    try:
        ...
        model_text = model.transcribe('3. Lazy Student GUI\downloaded_video', fp16=False)['text'] # works till this line. Gives transcription output
...
#image logo
logo_img = PhotoImage(file='3. Lazy Student GUI\yt.png')
#resize
...
#Download btns
download_btn = Button(screen, text="Download File",bg='green', padx='22', pady='5',font=('Arial', 15), fg='#fff', command=download__transcribe_summarise_file)
#add to canvas
